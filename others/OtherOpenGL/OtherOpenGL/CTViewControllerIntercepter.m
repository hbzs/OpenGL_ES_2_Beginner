...
- (instancetype)init
{
    ...
    if (self) {
        ...
        /* 在这里做好方法拦截 */
//        [UINavigationController aspect_hookSelector:@selector(viewDidLoad) withOptions:AspectPositionAfter usingBlock:^(id<AspectInfo>aspectInfo){
...
//  navController.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"" style:navController.navigationItem.backBarButtonItem.style target:nil action:nil];
//
//}
